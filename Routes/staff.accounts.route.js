...
router.get("/all-pending-approvals", verifyStaffToken, checkPermission(roles.fullAccessOnAccounts), staffAccountController.getAllPendingApprovals)
router.get("/all-account-names", verifyStaffToken, checkPermission(roles.canAccessOnAccounts), staffAccountController.getAllAccountNames)
...
router.put("/reset", verifyStaffToken, checkPermission(roles.fullAccessOnAccounts), staffAccountController.resetAmounts)
router.put("/resetApprovals", verifyStaffToken, checkPermission(roles.fullAccessOnAccounts), staffAccountController.removeAllPendingRequests)
