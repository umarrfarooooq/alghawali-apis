...
router.get(
  ...
  maidController.getAllHiredMaids
);
...
router.get(
  ...
  maidController.getAllMaidsWithHired
);
router.get(
  "/withMonthlyHired",
  verifyStaffToken,
...
router.get(
  ...
  verifyStaffToken,
  maidController.getAllMonthlyHiredMaidsByStaffId
);
router.get(
  "/byStaff/hired/:staffId",
  verifyStaffToken,
  maidController.getAllHiredMaidsByStaffId
);
router.get(
...
router.post(
  "/",
  verifyStaffToken,
  checkPermission(roles.CanAddMaid),
  upload.fields([
...
router.put(
  "/:id",
  verifyStaffToken,
  checkPermission(roles.CanEditMaid),
  upload.fields([
    { name: "maidImg", maxCount: 1 },
    { name: "maidImg2", maxCount: 1 },
    { name: "maidImg3", maxCount: 1 },
...
router.put(
  "/availablity/:id",
  verifyStaffToken,
  checkPermission(roles.ShowOurMaid),
  maidController.updateMaidAvailablity
);
router.delete(
  "/delete/:id",
  verifyStaffToken,
  checkPermission(roles.ShowOurMaid),
  maidController.deleteMaid
);
...
router.get(
  ...
  verifyStaffToken,
  checkPermission(roles.canAccessOnAccounts),
  maidController.getHiringById
);
router.post(
  "/unHiring/:id",
  verifyStaffToken,
  checkPermission(roles.canAccessOnAccounts),
  maidController.createListAgain
);
router.put(
  "/hiring/update/:id",
  verifyStaffToken,
  checkPermission(roles.canAccessOnAccounts),
  upload.single("hiringSlip"),
  maidController.updateHiringById
);
router.put(
  "/hiring/edit/:id",
  verifyStaffToken,
  checkPermission(roles.canAccessOnAccounts),
  upload.single("hiringSlip"),
  maidController.editHiringById
);
router.get(
  "/maid-history/:id",
  verifyStaffToken,
  checkPermission(roles.canAccessOnAccounts),
  maidController.getMaidHistory
);
